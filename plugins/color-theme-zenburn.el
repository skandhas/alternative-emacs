...
(defun color-theme-zenburn ()
  ...
  (color-theme-install
   `(color-theme-zenburn
     ...
     (zenburn-warning-face ((t (:foreground ,zenburn-red-2 :weight bold :underline t))))
     ...
     ;; faces used by isearch
      (isearch ((t (:foreground ,zenburn-yellow :background "#668b8b" :underline t))))
      (isearch-fail ((t (:foreground ,zenburn-fg :background ,zenburn-red-4))))
      (lazy-highlight ((t (:foreground ,zenburn-yellow :background "#506070" :underline nil))))
     ...
     (org-level-1 ((t (:bold t :foreground ,zenburn-orange :height 1.3))))
     (org-level-2 ((t (:bold nil :foreground ,zenburn-green :height 1.2))))
     (org-level-3 ((t (:bold t :foreground ,zenburn-blue-2 :height 1.1))))
     (org-level-4 ((t (:bold nil :foreground ,zenburn-red-3 :height 1.0))))
     (org-level-5 ((t (:foreground ,zenburn-orange :height 1.0))))
     (org-level-6 ((t (:foreground ,zenburn-green-1 :height 1.0))))
     (org-level-7 ((t (:foreground ,zenburn-blue-3 :height 1.0))))
     (org-level-8 ((t (:foreground ,zenburn-red-4 :height 1.0))))
